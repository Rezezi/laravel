...
<body>
    ...
    <div class="container">
        ...
        <form action="/lembur/update" method="post">
            {{csrf_field()}}
            <input type="hidden" name="id" value="{{$r->lembur_id}}"><br>
            
            <div class="mb-3">
                <label for="pegawai_id">Pegawai ID:</label><br>
                <input type="number" name="pegawai_id" id="pegawai_id" required="required" value="{{$r->pegawai_id}}">
            </div>
            <div class="mb-3">
                <label for="bulan_lembur">Bulan Lembur:</label><br>
                <input type="text" name="bulan_lembur" id="bulan_lembur" required="required" value="{{$r->bulan_lembur}}">
            </div>
            <div class="mb-3">
                <label for="jumlah_lembur">Jumlah Lembur:</label><br>
                <input type="number" name="jumlah_lembur" id="jumlah_lembur" required="required" value="{{$r->jumlah_lembur}}">
            </div>
