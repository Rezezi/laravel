...
<body>
    <div class="container">
        ...
        <div class="text-end mb-3">
            ...
            <a href="/golongan/tambah" class="btn btn-add btn-custom">+ Tambah Golongan Baru</a>
        </div>
        <table class="table table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="/golongan/edit/{{ $g->golongan_id }}" class="btn btn-edit btn-custom">Edit</a>
                        <a href="/golongan/hapus/{{ $g->golongan_id }}" class="btn btn-delete btn-custom">Hapus</a>
                    </td>
                </tr>
                @endforeach
            </tbody>
